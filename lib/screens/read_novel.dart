...
class ReadingPage extends StatefulWidget {
  ...
  const ReadingPage({super.key, required this.chapterId});
  ...
  void _addComment({String? replyTo}) {
    if (_commentController.text.trim().isNotEmpty) {
      setState(() {
        ...
        _replyTo = null; // Reset the replyTo to ensure the state is ready for a new comment
      });
    }
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Dữ liệu đang được tải, hiển thị loading spinner
          return const Center(
          ...
          // Dữ liệu đã sẵn sàng, hiển thị nội dung
