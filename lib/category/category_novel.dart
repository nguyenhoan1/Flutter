...
import 'package:truyencuatui/category/List_novel.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const categoryNovel(),
    );
  }
}

class categoryNovel extends StatefulWidget {
  const categoryNovel({super.key});

  @override
  _CategoryPageState createState() => _CategoryPageState();
}

class _CategoryPageState extends State<categoryNovel> {
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const ListNovel()), 
                      );
                    },
                    child: Container(
