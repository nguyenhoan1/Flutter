...
import 'package:truyencuatui/category/List_category.dart';
...
class _CategoryPageState extends State<CategoryPage> {
  ...
  void initState() {
    super.initState();
    fetchData();
    checkLoginStatus(); // Gọi hàm fetchData() khi widget được khởi tạo
  }
              ...
              child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    onTap: () =>
                        _navigateToCategory(context, categories[index].id),
                    child: Container(
