...
class _CategoryPageState extends State<ListNovel> {
  ...
  void _logOut() async {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
          builder: (context) =>
              const MyApp()), // Navigate to the login screen or main screen after logout
    );
  }
    ...
    try {
      ...
      if (await _authService.isLoggedIn()) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  const MyApp()), // Assuming MyApp is the main screen after login
        );
      }
    } catch (e) {
      showDialog(
